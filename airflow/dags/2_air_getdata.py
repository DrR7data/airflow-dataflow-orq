...
def ProcessEmployees():
    ...
    create_employees_temp_table = SQLExecuteQueryOperator(
        ...
        conn_id="tutorial_pg_conn",
        sql="""
            DROP TABLE IF EXISTS employee.employees_temp;
            CREATE TABLE employee.employees_temp (
                "Serial Number" NUMERIC PRIMARY KEY,
                "Company Name" TEXT,
                "Employee Markme" TEXT,
                "Description" TEXT,
    ...
    def get_data():
        ...
        with open(data_path, "r") as file:
            cur.copy_expert(
                "COPY employee.employees_temp FROM STDIN WITH CSV HEADER DELIMITER AS ',' QUOTE '\"'",
                file,
            )
        conn.commit()
    ...
    create_schema_employees()>>[create_employees_table, create_employees_temp_table] >> get_data() >> merge_data()
